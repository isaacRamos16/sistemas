...
<flux:breadcrumbs class="mb-8">
    ...
    <a href="{{route('admin.estado-equipo.create')}}" class="bg-green-500 mb-8 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        ...
        @foreach($estado_equipo as $item)
            <tr>
                ...
                <td >
                    <div class="grid">
                        <div>
                            <flux:modal.trigger name="edit-estado-equipo-{{ $item->id_estado_equipo }}">
            ...
            <flux:modal name="edit-estado-equipo-{{ $item->id_estado_equipo }}" class="md:w-96">
                <form action="{{ route('admin.estado-equipo.destroy', $item->id_estado_equipo) }}" method="POST" class="delete-form">
                    ...
                    <div class="space-y-6">
                        <div>
                            <flux:heading size="lg">Editar Estado Equipo</flux:heading>
                            <flux:text class="mt-2">Modifica la descripción del Estado Equipo.</flux:text>
                        </div>
